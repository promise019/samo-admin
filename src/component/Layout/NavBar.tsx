...
export default function NavBar() {
  return (
    <nav className="w-screen px-8 md:px-0 justify-between bottom-0 fixed flex md:block md:h-screen md:w-fit space-y-2 bg-red-950 pt-4 md:sticky md:top-0 text-white">
